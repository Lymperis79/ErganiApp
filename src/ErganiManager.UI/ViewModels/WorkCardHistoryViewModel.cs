...
public partial class WorkCardHistoryViewModel : ViewModelBase, IAdminSectionViewModel
{
    ...
    private async Task LoadFiltersAsync()
    {
        ...
        var employees = await _employeeService.GetByCompanyAsync(companyId, activeOnly: false);
    ...
    private async Task LoadAsync()
    {
        ...
        try
        {
            ...
            {
                FromDate = DateOnly.FromDateTime(FilterFromDate.LocalDateTime),
                ToDate = DateOnly.FromDateTime(FilterToDate.LocalDateTime),
            ...
            var results = await _historyService.GetAsync(companyId, filter);
            Records.Clear();
